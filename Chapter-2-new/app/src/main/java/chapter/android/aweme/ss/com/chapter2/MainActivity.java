...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {//监听器接口


    @Override
    protected void onCreate(Bundle savedInstanceState) {//设置监听器
    ...
    @Override
    public void onClick(View v) {//实现来自OnClickListener接口中的方法
        switch (v.getId()) {
            case R.id.btn_xml:
