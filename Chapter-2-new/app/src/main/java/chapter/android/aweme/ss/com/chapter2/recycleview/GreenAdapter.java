...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public GreenAdapter(int numListItems, ListItemClickListener listener) {//构造函数
    ...
    public class NumberViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(int position) {
            listItemNumberView.setText(String.valueOf(position));//在View界面设置每个item的序号
...
//            itemView.setBackgroundColor(backgroundColorForViewHolder);
    ...
    public interface ListItemClickListener {//接口及其方法
