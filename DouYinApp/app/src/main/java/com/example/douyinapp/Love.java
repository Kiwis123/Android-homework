...
public class Love extends RelativeLayout {
    ...
    private void initView() {
        ...
        // 图片资源
        icons[0] = getResources().getDrawable(R.drawable.ic_heart);
        icons[1] = getResources().getDrawable(R.drawable.ic_heart);
        icons[2] = getResources().getDrawable(R.drawable.ic_heart);
        icons[3] = getResources().getDrawable(R.drawable.ic_heart);
